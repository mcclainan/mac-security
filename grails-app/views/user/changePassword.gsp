                ...
                <div class="6u">
                    <section>
                        ...
                        <g:form action="updatePassword">
                            ...
                            <div class="row half">
                                <div class="6u">
                                    <g:textField value="${command?.oldPassword}" type="password"  name="oldPassword" id="oldPassword" class="text" placeholder="${message(code: 'changePasswordCommand.oldPassword.label')}" />
                                </div>
                            </div>
                            <div class="row half">
                                <div class="6u">
